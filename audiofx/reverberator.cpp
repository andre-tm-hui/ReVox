...
Reverberator::Reverberator(int bufSize)
  ...
  paramMap["Damp"] = {"FXDial", "%", "Set how quickly the echoes decay", 0,
                      100};
...
bool Reverberator::GetEnabled() { return rev->getEnabled(); }

void Reverberator::SetEnabled(bool enabled) {
  log(INFO, enabled ? "Enabling reverberator" : "Disabling reverberator");
