...
const std::vector<int> scales{2741, 1387, 2774, 1453, 2906, 1717,
                              3434, 2773, 1451, 2902, 1709, 3418};
const std::vector<QString> labels{"C",  "Db", "D",  "Eb", "E",  "F",
                                  "Gb", "G",  "Ab", "A",  "Bb", "B"};
...
class FXKeyPicker : public FXParam {
 ...
 public:
  explicit FXKeyPicker(std::shared_ptr<FXManager> fm, std::string fx,
